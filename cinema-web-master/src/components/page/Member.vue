...
-->
        ...
        <div class="container">
            <div class="handle-box">
                <el-button type="primary" icon="el-icon-delete" class="handle-del mr10" @click="handleRegister">会员注册 </el-button>
                <!--使用下拉选择菜单来选择搜索条件-->
            ...
            <el-form ref="registerForm" :model="registerForm" :rules="rules" label-width="70px">
                ...
                <el-form-item label="密码" prop="password">
                    <el-tooltip placement="top">
                        <div slot="content">默认密码为：123。无需手动设值</div>
                        <el-input v-model="registerForm.password" disabled show-password placeholder="请输入密码"></el-input>
                    </el-tooltip>
                </el-form-item>
                <el-form-item label="性别" prop="sex">
